...
public class LList implements List<Object> //interface def must be in this dir
{
  ...
  special case if index == 0, we just do default add with Object
  ...
  */
  public Object remove(int index) {
    ...
    if (index == 0) {return removeFirst();}
      ...
      Object removed = temp.getNext().getCargo();
